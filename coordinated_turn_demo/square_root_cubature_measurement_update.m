function xS_corrected = square_root_cubature_measurement_update (xS0,measurement,measurement_fun,measurement_noise)
...
%Almost verbatim copy
%A comment is for the line of code preceeding itself.
...
%End of copied part.
%Reformat output:
xS_corrected = mean_covariance_sqrt_cls(xkk,Skk);
end
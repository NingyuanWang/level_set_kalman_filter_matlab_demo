...
nexttile(1)
loglog(dt./m_list,x_E_CDCKF,'-o')
hold on
loglog(dt./m_list,x_E_CDCKF_ts,'--x')
loglog(dt./m_list,x_E_LSKF,'-.+')
loglog(dt./m_list(3:end),x_E_LSKF_RK4(3:end),':*')
xlabel('timestep')
ylabel('error (L_2 norm)')
legend({'CDCKF','IT 1.5','LSKF-RK2','LSKF-RK4'},'Location','NorthWest')
title('error in mean')
nexttile(2)
loglog(dt./m_list,S_E_CDCKF,'-o')
hold on
loglog(dt./m_list,S_E_CDCKF_ts,'--x')
loglog(dt./m_list,S_E_LSKF,'-.+')
loglog(dt./m_list(3:end),S_E_LSKF_RK4(3:end),':*')
xlabel('timestep')
